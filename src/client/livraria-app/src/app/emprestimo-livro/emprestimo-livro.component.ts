...
import { ErroEmprestimo, Erro1, Erro2 } from '../model/erros/emprestimo.response.erro';
...
export class EmprestimoLivroComponent implements OnInit {
  ...
  manipulaErros(erro) {
    ...
    try {
      let errorValidation = erro as Erro2

      
      errorValidation.erro.forEach(element => {
        
        this.alerts.push({
          type: 'danger',
          message: 'Ops: ' + element.errorMessage
        })
      });
      console.log('1')
    } catch{ }
